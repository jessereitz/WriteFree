var WriteFree = (function () {
  ...
  */
  ...
  var editorBase = {
    ...
    */
    ...
    keydownHandler: function keydownHandler(e) {
      ...
      if (isDeletionKey(e)) {
        if (e.key === 'Backspace' && sel.anchorOffset === 0 && sel.focusOffset === sel.focusNode.textContent.length && sel.anchorNode === sel.focusNode) {
          this.deleteContainerSection(e);
        } else if (e.key === 'Delete' && sel.anchorOffset === sel.anchorNode.textContent.length && sel.focusOffset === sel.focusNode.textContent.length && sel.anchorNode === sel.focusNode) {
          this.deleteContainerSection(e);
        }
      }
  ...
  var defaultLargeHeadingStyle = Object.create(defaultSectionStyle);
  defaultLargeHeadingStyle['font-size'] = '2rem';
  var defaultSmallHeadingStyle = Object.create(defaultSectionStyle);
  defaultSmallHeadingStyle['font-size'] = '1.5rem';
  var defaultImgStyle = Object.create(defaultSectionStyle);
